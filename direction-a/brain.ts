...
export class EditorialBrain {
  ...
  constructor(container: HTMLElement, mobile = false) {
    ...
    center.innerHTML = `
      <p class="id-tagline">a pioneer at the frontier of light and thought</p>
